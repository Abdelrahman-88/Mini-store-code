...
ProductsModule = __decorate([
    (0, common_1.Module)({
        imports: [config_1.ConfigModule, auth_module_1.AuthModule, mongoose_1.MongooseModule.forFeatureAsync([
                {
                    name: 'Product',
                    useFactory: () => {
                        const schema = product_entity_1.ProductSchema;
                        return schema;
                    }
                }
            ])
        ...
        providers: [products_service_1.ProductsService, pages_service_1.PagesService, upload_service_1.UploadService, search_service_1.SearchService]
    })
], ProductsModule);
